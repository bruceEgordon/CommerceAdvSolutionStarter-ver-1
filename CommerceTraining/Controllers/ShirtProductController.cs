...
namespace CommerceTraining.Controllers
{
    public class ShirtProductController : CatalogControllerBase<ShirtProduct>
    {
        ...
        public ShirtProductController(IContentLoader contentLoader, UrlResolver urlResolver, AssetUrlResolver assetUrlResolver, ThumbnailUrlResolver thumbnailUrlResolver, IRelationRepository relationRepository) : base(contentLoader, urlResolver, assetUrlResolver, thumbnailUrlResolver)
        {
        ...
        {
            var variants = currentContent.GetVariants(_relationRepository).Select(contentLink => _contentLoader.Get<ShirtVariation>(contentLink));
